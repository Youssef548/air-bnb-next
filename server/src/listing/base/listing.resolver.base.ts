...
export class ListingResolverBase {
  ...
  async createListing(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        listingCreaterBy: {
          connect: args.data.listingCreaterBy,
        },
      },
    });
  }
  ...
  async resolveFieldListingCreaterBy(
    @graphql.Parent() parent: Listing
  ): Promise<User | null> {
    const result = await this.service.getListingCreaterBy(parent.id);
